...
const CallPutItem = ({option,setExerciseOrder}) => {
    ...
    return (
        <li>
            {option.buy_sell_type} {option.n_contracts} {option.call_put_contract.stock.ticker} {option.call_put_contract.call_put_type} @{option.bought_c_price}
