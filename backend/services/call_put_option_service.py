...
class CallPutOptionService:
    ...
    def make_position(contract,buy_sell_type,n_contracts,user):
        ...
        if buy_sell_type == "BUY":
            ...
            if user.money >= order_cost:
                ...
                return CallPutOption(contract,n_contracts,buy_sell_type,contract.current_c_price,contract.current_contract_value,user)
            else:
