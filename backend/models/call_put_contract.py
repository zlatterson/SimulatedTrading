...
class CallPutContract:
    def __init__(self,contract_name:str,stock:Stock,call_put_type:str,current_c_price:float,k:float,expires,id=None):
    ...
    def fetch_c_price(self):
        ...
        self.current_c_price = CallPutContractService.calc_c_simulated_price(updated_contract)