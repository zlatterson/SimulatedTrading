...
class CallPutOption():
    def __init__(self,call_put_contract:CallPutContract,buy_sell_type:str,n_contracts:int,bought_c_price:float,bought_contracts_value:float,timestamp,user:User,id=None):
